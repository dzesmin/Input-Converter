...
def PT_Inversion(a1, a2, p1, p2, p3, T0, noLevels):
     '''
     ...
     PT_Inv, T_smooth = PT_Inversion(a1, a2, p1, p2, p3, T0, noLevels)

     # returns full temperature array and temperatures at every point
     T, p, T1, T2, T3 = PT_Inv[8], PT_Inv[9], PT_Inv[10], PT_Inv[11], PT_Inv[12]
     ...
     # PT profile
     PT_Inver = (T_l1, p_l1, T_l2_pos, p_l2_pos, T_l2_neg, p_l2_neg, T_l3, p_l3, T_conc, p_conc, T1, T2, T3)
...
def PT_NoInversion(a1, a2, p1, p3, T0, noLevels):
     '''
     ...
     PT_NoInv, T_smooth = PT_NoInversion(a1, a2, p1, p3, T0, noLevels)

     # returns full temperature array and temperatures at every point
     T, p, T1, T3 = PT_NoInv[6], PT_NoInv[7], PT_NoInv[8], PT_NoInv[9]
     ...
     # PT profile
     PT_NoInver = (T_l1, p_l1, T_l2_neg, p_l2_neg, T_l3, p_l3, T_conc, p, T1, T3)
