...
# adiabatic PT profile, generates the profile and plots it. Free 
# parameters returned by the fucntion adiabtaicPT_freeParams will be
# used as an initial guess for DEMC.  ======================================================================

# generates free parameters for adiabatic PT profile
def adiabaticPT_freeParams(tepfile):
     '''
...
def PT_adiabatic(tepfile):
    ...
    # takes free parameters
     a1, a2, p1, p3, T3 = adiabaticPT_freeParams(tepfile)
